...
公開中＆追加要素可能性あり。Windows版0.3.0、Android試験版0.3.1、Unity 6000.6.0f1。
...
- Android試験版のアプリアイコンを、ゲーム内のカード裏面と中央ロゴを使った専用デザインへ変更。
- 通常、丸型、Android 8以降のアダプティブアイコンへ同じデザインを設定。
...
配布物はバージョンごとのGitHub Releaseへアップロードします。
